// RUN: pocl-mlir-opt --pocl-distribute-barriers="method=distribute.mincut.ifhoist" --split-input-file %s | %FileCheck %s
// RUN: pocl-mlir-opt --pocl-distribute-barriers="method=distribute.mincut.ifsplit" --split-input-file %s | %FileCheck %s -check-prefix=IFSPLIT
...
// CHECK-NEXT:          %[[V3:.+]] = "pocl.subindex"(%[[V1]], %[[arg3]]) : (memref<?xi32>, index) -> memref<i32>
...
// CHECK-NEXT:          %[[V3:.+]] = "pocl.subindex"(%[[V1]], %[[arg3]]) : (memref<?xi32>, index) -> memref<i32>
// CHECK-NEXT:          memref.store %[[V2]], %[[V3]][] : memref<i32>
// CHECK-NEXT:          %[[V4:.+]] = "pocl.subindex"(%[[V1]], %[[arg3]]) : (memref<?xi32>, index) -> memref<i32>
...
// IFSPLIT-NEXT:          %[[V3:.+]] = "pocl.subindex"(%[[V1]], %[[arg3]]) : (memref<?xi32>, index) -> memref<i32>
// IFSPLIT-NEXT:          memref.store %[[V2]], %[[V3]][] : memref<i32>
// IFSPLIT-NEXT:          %[[V4:.+]] = "pocl.subindex"(%[[V0]], %[[arg3]]) : (memref<?xi32>, index) -> memref<i32>
...
// IFSPLIT-NEXT:      scf.parallel (%[[arg3:.+]]) = (%[[c0]]) to (%[[c9]]) step (%[[c1]]) {
// IFSPLIT-NEXT:        scf.if %[[arg0]] {
// IFSPLIT-NEXT:          %[[V2:.+]] = "pocl.subindex"(%[[V1]], %[[arg3]]) : (memref<?xi32>, index) -> memref<i32>
...
// IFSPLIT-NEXT:          func.call @use(%[[V2:.+]]) : (i32) -> ()
// IFSPLIT-NEXT:          %[[V3:.+]] = "pocl.subindex"(%[[V0]], %[[arg3]]) : (memref<?xi32>, index) -> memref<i32>
// IFSPLIT-NEXT:          memref.store %[[V2]], %[[V3]][] : memref<i32>
// IFSPLIT-NEXT:        }
// IFSPLIT-NEXT:        scf.reduce
// IFSPLIT-NEXT:      }
// IFSPLIT-NEXT:      scf.parallel (%[[arg3:.+]]) = (%[[c0]]) to (%[[c9]]) step (%[[c1]]) {
// IFSPLIT-NEXT:        scf.if %[[arg0]] {
// IFSPLIT-NEXT:          %[[V4:.+]] = "pocl.subindex"(%[[V1]], %[[arg3]]) : (memref<?xi32>, index) -> memref<i32>
// IFSPLIT-NEXT:          %[[V5:.+]] = memref.load %[[V4]][] : memref<i32>
// IFSPLIT-NEXT:          func.call @use(%[[V5:.+]]) : (i32) -> ()
// IFSPLIT-NEXT:          %[[V6:.+]] = "pocl.subindex"(%[[V0]], %[[arg3]]) : (memref<?xi32>, index) -> memref<i32>
// IFSPLIT-NEXT:          memref.store %[[V5]], %[[V6]][] : memref<i32>
// IFSPLIT-NEXT:        } else {
// IFSPLIT-NEXT:        }
// IFSPLIT-NEXT:        %[[V2:.+]] = "pocl.subindex"(%[[V0]], %[[arg3]]) : (memref<?xi32>, index) -> memref<i32>
// IFSPLIT-NEXT:        %[[V3:.+]] = memref.load %[[V2]][] : memref<i32>
// IFSPLIT-NEXT:        func.call @use(%[[V3:.+]]) : (i32) -> ()
// IFSPLIT-NEXT:        scf.reduce
// IFSPLIT-NEXT:      }
